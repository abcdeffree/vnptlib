...
public class LayoutTag extends TagSupport
{
    ...
    public int doStartTag() throws JspException
    {
        ...
        // Right bar: "default" is default :)
        if (rightbar == null)
        {
            rightbar = "default";
        }

        if (rightbar.equals("off"))
        {
            request.setAttribute("dspace.layout.rightbar", "off");
        }
        else
        {
            request.setAttribute("dspace.layout.rightbar", "/layout/rightbar-"
                    + rightbar + ".jsp");
        }
