...
public class BrowseItem extends DSpaceObject
{
    ...
    public Collection[] getCollections() throws SQLException
    {
        ...
        TableRowIterator tri = DatabaseManager.queryTable(this.context,"collection",
        ...
        try
        {
            while (tri.hasNext())
            {
                ...
                Collection fromCache = (Collection) this.context.fromCache(
                ...
                {
                    collections.add(new Collection(this.context, row));
                }
            }
        }
        finally
