...
<% if(bSubmittersButton || bWorkflowsButton || bAdminCreateGroup || (admins != null && bAdminRemoveGroup)) { %>
            <tr><td colspan="2"><h3><fmt:message key="jsp.tools.edit-collection.form.label9"/></h3></td></tr>
...
<%-- ===========================================================
     ...
     =========================================================== --%>
     		...
     		<tr><td>&nbsp;</td></tr>
            <tr><td colspan="2"><h3><fmt:message key="jsp.tools.edit-collection.form.label15"/></h3></td></tr>
