...
<dspace:layout titlekey="jsp.tools.edit-item-form.title"
    ...
    <script  src="<%= request.getContextPath() %>/dspace-admin/js/jquery-1.4.2.min.js"></script>
    <script  src="<%= request.getContextPath() %>/dspace-admin/js/bitstream-ordering.js"></script>
